...
!BOP
! !ROUTINE: noahmp401_updatesnwdvars
! \label{noahmp401_updatesnwdvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_updatesnwdvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine noahmp401_updatesnwdvars
