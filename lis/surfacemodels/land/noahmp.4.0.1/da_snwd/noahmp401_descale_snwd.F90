...
!BOP
! !ROUTINE: noahmp401_descale_snwd
! \label{noahmp401_descale_snwd}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_descale_snwd(n, LSM_State, LSM_Incr_State)
...
end subroutine noahmp401_descale_snwd
