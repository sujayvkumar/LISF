...
!EOP
  ...
  character(len=LIS_CONST_PATH_LEN)     :: filen,temp1
  character*1       :: fproc(4)
  ...
  do n=1, LIS_rc%nnest
     ...
     elseif(LIS_rc%startcode .eq. "restart") then
        ...
        if(wformat.eq."distributed binary") then
           ...
           NOAHMP401_struc(n)%rfile = trim(NOAHMP401_struc(n)%rfile)//&
        ...
        if(wformat.eq."distributed binary") then
           read(ftn) NOAHMP401_struc(n)%noahmp401%sfcrunoff
           read(ftn) NOAHMP401_struc(n)%noahmp401%udrrunoff
           ...
           do l=1, NOAHMP401_struc(n)%nsoil   ! TODO: check loop
              ...
              enddo
           enddo
           read(ftn) NOAHMP401_struc(n)%noahmp401%sneqv
           read(ftn) NOAHMP401_struc(n)%noahmp401%snowh
           read(ftn) NOAHMP401_struc(n)%noahmp401%canwat
           read(ftn) NOAHMP401_struc(n)%noahmp401%acsnom
           read(ftn) NOAHMP401_struc(n)%noahmp401%acsnow
           read(ftn) NOAHMP401_struc(n)%noahmp401%isnow
           read(ftn) NOAHMP401_struc(n)%noahmp401%tv
           read(ftn) NOAHMP401_struc(n)%noahmp401%tg
           read(ftn) NOAHMP401_struc(n)%noahmp401%canice
           read(ftn) NOAHMP401_struc(n)%noahmp401%canliq
           read(ftn) NOAHMP401_struc(n)%noahmp401%eah
           read(ftn) NOAHMP401_struc(n)%noahmp401%tah
           read(ftn) NOAHMP401_struc(n)%noahmp401%cm
           read(ftn) NOAHMP401_struc(n)%noahmp401%ch
           read(ftn) NOAHMP401_struc(n)%noahmp401%fwet
           read(ftn) NOAHMP401_struc(n)%noahmp401%sneqvo
           read(ftn) NOAHMP401_struc(n)%noahmp401%albold
           read(ftn) NOAHMP401_struc(n)%noahmp401%qsnow
           read(ftn) NOAHMP401_struc(n)%noahmp401%wslake
           read(ftn) NOAHMP401_struc(n)%noahmp401%zwt
           read(ftn) NOAHMP401_struc(n)%noahmp401%wa
           read(ftn) NOAHMP401_struc(n)%noahmp401%wt
           ...
           do l=1, NOAHMP401_struc(n)%nsnow   ! TODO: check loop
              ...
              enddo
           enddo
           read(ftn) NOAHMP401_struc(n)%noahmp401%lfmass
           read(ftn) NOAHMP401_struc(n)%noahmp401%rtmass
           read(ftn) NOAHMP401_struc(n)%noahmp401%stmass
           read(ftn) NOAHMP401_struc(n)%noahmp401%wood
           read(ftn) NOAHMP401_struc(n)%noahmp401%stblcp
           read(ftn) NOAHMP401_struc(n)%noahmp401%fastcp
           read(ftn) NOAHMP401_struc(n)%noahmp401%lai
           read(ftn) NOAHMP401_struc(n)%noahmp401%sai
           read(ftn) NOAHMP401_struc(n)%noahmp401%tauss
           ...
           do l=1, NOAHMP401_struc(n)%nsoil   ! TODO: check loop
              ...
              enddo
           enddo
           read(ftn) NOAHMP401_struc(n)%noahmp401%smcwtd
           read(ftn) NOAHMP401_struc(n)%noahmp401%deeprech
           read(ftn) NOAHMP401_struc(n)%noahmp401%rech
           read(ftn) NOAHMP401_struc(n)%noahmp401%grain
           read(ftn) NOAHMP401_struc(n)%noahmp401%gdd
           read(ftn) NOAHMP401_struc(n)%noahmp401%pgs
