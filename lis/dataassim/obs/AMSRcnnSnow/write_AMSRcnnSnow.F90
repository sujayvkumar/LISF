...
!BOP
! 
! !ROUTINE: write_AMSRcnnSnow
! \label{write_AMSRcnnSnow}
! 
! !REVISION HISTORY: 
!  04 Jan 2024: Sujay Kumar; Initial version
! 
! !INTERFACE: 
subroutine write_AMSRcnnSnow(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
! AMSRcnnSnow observations a file
! 
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call AMSRcnnSnow_obsname(n,k,obsname)        
...
end subroutine write_AMSRcnnSnow

!BOP
! !ROUTINE: AMSRcnnSnow_obsname
! \label{AMSRcnnSnow_obsname}
! 
! !INTERFACE: 
subroutine AMSRcnnSnow_obsname(n,k,obsname)
! !USES: 
...
end subroutine AMSRcnnSnow_obsname
