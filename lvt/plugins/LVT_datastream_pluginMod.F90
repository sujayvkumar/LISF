...
!EOP
    ...
    use NOAAGLDAS_obsMod,       only : NOAAGLDAS_obsinit
...
! MN: SMAP L3 Tb
    ...
    call registerobssetup(trim(LVT_NOAAGLDASobsId)//char(0), &
         NOAAGLDAS_obsinit)
    call registerobsread(trim(LVT_NOAAGLDASobsId)//char(0),&
         readNOAAGLDASobs)
