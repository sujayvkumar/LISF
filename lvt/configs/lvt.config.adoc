...
! "`MCD15A2H LAI`"                  | MODIS LAI data at 500m
|===
...
`LPRM AMSR-E use raw data:` specifies whether to use the LPRM AMSR-E raw data. Acceptable values are:
...
`MCD15A2H data directory::` specifies the location of the MCD15A2H LAI directory.

.Example _lvt.config_ entry
....
MCD15A2H data directory: ../MCD15A2H
....
